...
module.exports = class tables1624060947131 {
    name = 'tables1624060947131'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "zip" character varying(255) NOT NULL, "street" character varying(255) NOT NULL, "number" integer, "neighborhood" character varying(100) NOT NULL, "city" character varying(255), "state" character varying(100) NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
