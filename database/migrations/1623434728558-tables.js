...
module.exports = class tables1623434728558 {
    name = 'tables1623434728558'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "patient_record_history" ("id" SERIAL NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "description" character varying(255) NOT NULL, "patientRecordId" integer, "specialistId" integer, CONSTRAINT "REL_4d1fb6bd1d00de9fe72d6b5512" UNIQUE ("specialistId"), CONSTRAINT "PK_35b6288c21fec50e5b4faba6b6b" PRIMARY KEY ("id"))`);
