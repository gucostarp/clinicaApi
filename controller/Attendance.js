...
const get = async(req, res) => {
    ...
    try {
        ...
        res.status(400).json({ message: req.t('attendance_list_error') });
    }
};
...
const deleteOne = async(req, res) => {
    ...
    try {
        ...
        res.status(400).json({ message: req.t('attendance_deleting_error') });
    }
};
...
const update = async(req, res) => {
    ...
    try {
        ...
        res.status(400).json({ message: req.t('attendance_updating_error') });
    }
};
...
const insert = async(req, res) => {
    ...
    try {
        ...
        res.status(400).json({ message: req.t('attendance_create_error') });
    }
};
