...
const get = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('patient_record_list_error') });
    }
};
...
const deleteOne = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('patient_record_deleting_error') });
    }
};
...
const update = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('patient_record_updating_error') });
    }
};
...
const insert = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('patient_record_create_error') });
    }
};
