...
const get = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('specialist_list_error') });
    }
};
...
const deleteOne = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('specialist_deleting_error') });
    }
};
...
const update = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('specialist_updating_error') });
    }
};
...
const insert = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('specialist_create_error') });
    }
};
