...
const get = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('pat_record_history_list_error') });
    }
};
...
const deleteOne = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('pat_record_history_deleting_error') });
    }
};
...
const update = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('pat_record_history_updating_error') });
    }
};
...
const insert = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('pat_record_history_create_error') });
    }
};
