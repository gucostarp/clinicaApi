...
const get = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('occupation_list_error') });
    }
};
...
const deleteOne = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('occupation_deleting_error') });
    }
};
...
const update = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('occupation_updating_error') });
    }
};
...
const insert = async(req, res) => {
    ...
    try {
        ...
        res.status(404).json({ message: req.t('occupation_create_error') });
    }
};
